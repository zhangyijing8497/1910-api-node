...
<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
            @if($_SERVER['uid'])
                ...
                <li><a href="http://passport.1910.com/login?redirect={{$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']}}"><i class="fa fa-sign-in"></i>登录</a></li>
                <li><a href="{{url('/register')}}"><i class="fa fa-user-plus"></i>注册</a></li>
                <li><a href=""><i class="fa fa-user"></i>个人中心</a></li>
                <li><a href=""><i class="fa fa-cog"></i>退出</a></li>
            @else
                <li class="profil">
                    <img src="/Index/img/profile.jpg" alt="">
                </li>
...
<div class="navbar-bottom">
    <div class="row">
        ...
        <div class="col s2">
            <a href="{{url('/index/contact')}}"><i class="fa fa-envelope-o"></i></a>
        </div>
        <div class="col s2">
    ...
    <div class="modal-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col s4">
                    <a href="{{url('index/shop_single')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                                <i class="fa fa-eye"></i>
                            </div>
            ...
            <div class="row">
                <div class="col s4">
                    <a href="{{url('/index/wishlist')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('index/checkout')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
            ...
            <div class="row">
                <div class="col s4">
                    <a href="{{url('index/blog')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('index/blog_single')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('index/error_404')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
            ...
            <div class="row">
                <div class="col s4">
                    <a href="{{url('index/testimonial')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('index/about_us')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('index/contact')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
            ...
            <div class="row">
                <div class="col s4">
                    <a href="{{url('index/setting')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                                <i class="fa fa-cog"></i>
                            </div>
